 ...
 *
 * Messages can be directed here from different sources. Each source can have its messages displayed in a
 * different color.
 *
...
public class MessageConsole {
   ...
   *
   * The messages can either be appended to the end of the console or inserted as the first line of the
   * console.
   */
  ...
  /*
   * Redirect the output from the standard output to the console using the default text color and null
   * PrintStream
   */
   ...
   * When a PrintStream is specified the message will be added to the Document before it is also written to
   * the PrintStream.
   */
  ...
  /*
   * Redirect the output from the standard error to the console using the default text color and null
   * PrintStream
   */
   ...
   *
   * This number can be dynamically changed, but the console will only be updated the next time the Document
   * is updated.
   */
  ...
  /*
   * Class to intercept output from a PrintStream and add it to a Document. The output can optionally be
   * redirected to a different PrintStream. The text displayed in the Document can be color coded to indicate
   * the output source.
   */
  class ConsoleOutputStream extends ByteArrayOutputStream {
    ...
    /*
     * Override this method to intercept the output text. Each line of text output will actually involve
     * invoking this method twice:
     *
     * a) for the actual text message b) for the newLine string
     *
     * The message will be treated differently depending on whether the line will be appended or inserted into
     * the Document
     */
    public void flush() {
    ...
    /*
     * The message and the newLine have been added to the buffer in the appropriate order so we can now update
     * the Document and send the text to the optional PrintStream.
     */
